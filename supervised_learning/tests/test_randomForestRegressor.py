...
class TestRandomForestRegressor(TestCase):
    def test(self):
        my_reg = RandomForestRegressor(n_estimators=10, max_depth=5, max_features=5)
        sk_reg = sklearn.ensemble.RandomForestRegressor(n_estimators=10, max_depth=5, max_features=5)
    ...
    def test_boston(self):
        my_reg = RandomForestRegressor(n_estimators=30, max_depth=5, max_features=4)
